 ...
 * Misc
 */
$GLOBALS['TL_LANG']['MSC']['calendarfield_tooltip'] = 'Datum auswählen';
...
$GLOBALS['TL_LANG']['ERR']['calendarfield_direction_gtTodayTo'] = 'Bitte geben Sie ein Datum in der Zukunft (exkl. heute und morgen) ein.';
$GLOBALS['TL_LANG']['ERR']['calendarfield_disabled_weekday']  = 'Dieser Wochentag ist nicht erlaubt.';
$GLOBALS['TL_LANG']['ERR']['calendarfield_disabled_day']      = 'Dieses Datum ist nicht erlaubt.';
