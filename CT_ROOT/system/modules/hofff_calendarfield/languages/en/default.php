 ...
 * Misc
 */
$GLOBALS['TL_LANG']['MSC']['calendarfield_tooltip'] = 'Select date';
...
$GLOBALS['TL_LANG']['ERR']['calendarfield_direction_gtTodayTo'] = 'Please enter a date in the future (excluding today and tomorrow).';
$GLOBALS['TL_LANG']['ERR']['calendarfield_disabled_weekday']  = 'This weekday is not allowed.';
$GLOBALS['TL_LANG']['ERR']['calendarfield_disabled_day']      = 'This date is not allowed.';
